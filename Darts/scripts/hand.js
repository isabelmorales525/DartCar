...
function Hand(name, boardX, boardY, boardWidth, boardHeight) {
	...
	this.IMAGES2[0] = new Image(this.WIDTH, this.HEIGHT);
	this.IMAGES2[0].src = 'images/hand0p2.gif';
	this.IMAGES2[1] = new Image(this.WIDTH, this.HEIGHT);
	this.IMAGES2[1].src = 'images/hand1p2.gif';
	this.IMAGES2[2] = new Image(this.WIDTH, this.HEIGHT);
	this.IMAGES2[2].src = 'images/hand2p2.gif';
	this.IMAGES2[3] = new Image(this.WIDTH, this.HEIGHT);
	this.IMAGES2[3].src = 'images/hand3p2.gif';
	this.IMAGES2[4] = new Image(this.WIDTH, this.HEIGHT);
	this.IMAGES2[4].src = 'images/hand3p2.gif';
...
Hand.prototype.setImage = function(image) {
	var array_tmp;
	// call EN1 function: set player
	set_player(oGame.playerId);
	if (oGame.playerId == 0) { array_tmp = this.IMAGES; }
	else { array_tmp = this.IMAGES2; }
	this.setHTML(
		'<img border="0" src="' + array_tmp[image].src +
		'" width="' + this.WIDTH +
		'" height="' + this.HEIGHT +
		'" />'
	);
