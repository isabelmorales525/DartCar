...
function Board(name) {
	...
	Layer.call(
		...
		'<img border="0" src="' + this.IMAGE +
			...
			'" height="' + this.HEIGHT +
			'" />' +
			'<div id="score_overlay" style="border: 0px; margins: 0px; position:absolute; top:0px; left:0px; width:496px; height:496px;"></div>' +
			'<div id="balloon_overlay" style="border: 0px; margins: 0px; position:absolute; top:0px; left:0px; width:496px; height:496px;"></div>'
	);
}
